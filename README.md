...
Flask 기반 웹 애플리케이션을 구현하며 데이터 무결성을 유지하는 구조 설계의 중요성을 체감했습니다.

회원가입, 로그인 페이지를 구현하며 validation, 중복 데이터 처리, 예외 케이스를 처리하며 데이터의 신뢰성을 확보하고자 했습니다. 

또한 팀원들과 협업함으로써 더 완성도 높은 웹 페이지를 만들어낼 수 있었다고 생각합니다.
